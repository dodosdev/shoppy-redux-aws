...
select  pid,
		...
		price,
		description as info,
		concat('http://52.78.206.153:9000/', upload_file->>'$[0]') as image,
		source_file,
		pdate
from shoppy_product;

-- http://52.78.206.153:9000/["upload_files\\1739163158340-849078071-1.webp", "upload_files\\1739163158340-911632745-2.webp", "upload_files\\1739163158340-462908659-3.webp", "upload_files\\1739163158341-81325715-4.webp", "upload_files\\1739163158342-709014159-5.webp", "upload_files\\1739163158342-110372512-6.webp", "upload_files\\1739163158342-207791282-7.webp"]
--
-- http://52.78.206.153:9000/upload_files\\1739163158340-849078071-1.webp
...
select  pid,
        ...
        concat('http://52.78.206.153:9000/',upload_file->>'$[0]') as image,
        json_array(
			concat('http://52.78.206.153:9000/',upload_file->>'$[0]'),
            concat('http://52.78.206.153:9000/',upload_file->>'$[1]'),
            concat('http://52.78.206.153:9000/',upload_file->>'$[2]')
        ) as imgList,
        json_arrayagg(
			concat('http://52.78.206.153:9000/', jt.filename)
        ) as detailImgList
from shoppy_product,
...
select  sc.cid,
        ...
        concat('http://52.78.206.153:9000/', sp.upload_file->>'$[0]') as image        
	from shoppy_cart sc,
		 shoppy_member sm,
         shoppy_product sp
	where sc.id = sm.id 
...
select pid, brand, subject, price, upload_img, detail_imgs,
        concat('http://52.78.206.153:9000/', detail_imgs->>'$[0]') as image
from product_kurly;
